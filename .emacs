...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (god-mode ag helm-ag crux lispy hy-mode erefactor terminal-here moe-theme helm-themes basic-theme emamux eamux company-anaconda realgud-ipdb realgud helm-projectile gscholar-bibtex image+ picpocket ein fzf ob-sagemath sage-shell-mode pdfgrep undo-tree doom-modeline doom-themes magit counsel swiper framemove rotate which-key guide-key org-noter multiple-cursors ws-butler use-package transpose-frame tabbar stickyfunc-enhance srefactor py-autopep8 projectile origami org-ref org-pdfview org-elisp-help org-download neotree material-theme linum-relative ialign hide-mode-line helm-gtags golden-ratio ggtags function-args free-keys flycheck flash-region elpy elisp-slime-nav desktop+ darkroom company-c-headers centered-window auctex)))
