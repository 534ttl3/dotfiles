...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-noter yasnippet-snippets desktop+ transpose-frame evil-collection evil org-pdfview pdf-tools auctex-lua auctex-latexmk auctex yasnippet linum-relative exec-path-from-shell projectile))))
(custom-set-faces
