...
#+BEGIN_SRC emacs-lisp
  ...
  (defconst warning-minimum-level-backup warning-minimum-level)
#+END_SRC

#+RESULTS:
: warning-minimum-level-backup
...
#+BEGIN_SRC emacs-lisp
  (use-package backward-forward
    ...
    (define-key cs-keys-minor-mode-map (kbd "C-i") 'backward-forward-next-location))
#+END_SRC
