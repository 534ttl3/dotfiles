...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-x C-p") (lambda () (interactive) (counsel-fzf nil (expand-file-name "~")))))
...
#+BEGIN_SRC emacs-lisp
  (use-package backward-forward
    ...
    (define-key my-keys-minor-mode-map (kbd "C-o") 'backward-forward-previous-location)
    (define-key my-keys-minor-mode-map (kbd "C-i") 'backward-forward-next-location))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package paredit
    ...
    (define-key prog-mode-map (kbd "C-)") 'paredit-forward-slurp-sexp)
    (define-key prog-mode-map (kbd "C-(") 'paredit-backward-slurp-sexp)
    (define-key prog-mode-map (kbd "C-}") 'paredit-forward-barf-sexp)
    (define-key prog-mode-map (kbd "C-{") 'paredit-backward-barf-sexp)
    (define-key prog-mode-map (kbd "<M-up>")
      'paredit-splice-sexp-killing-backward)
    (define-key prog-mode-map (kbd "C-k") 'paredit-kill))
#+END_SRC
...
** random strings
#+BEGIN_SRC emacs-lisp
(add-to-list 'load-path (expand-file-name "~/.emacs.d/elisp/xah/"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key dired-mode-map (kbd "C-c C-o") 'dired-open-file)
#+END_SRC
